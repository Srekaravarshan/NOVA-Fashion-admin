...
class Category extends StatefulWidget {
  ...
  const Category({Key key, this.categoryName, this.collectionName})
      : super(key: key);
                        ...
                        builder: (context) {
                          return AlertDialog(
                            ...
                            actions: [
                              ...
                              TextButton(
                                onPressed: () async {
                                  DocumentSnapshot collections =
                                      await collectionRef
                                          .doc('collections')
                                          .get();
                                  Map collectionsValue =
                                      collections.data()['categories'];
                                  collectionsValue[widget.collectionName]
                                          [widget.categoryName]
